    ...
    public String makePrescription(Prescription prescription, ObservableList<PrescriptionDrug> drugs, Patient patient) {
        ...
        String string = html(
                ...
                body(
                        ...
                        div(
                                p(
                                        p("This Prescription is generate with Dcotor Assistant. This project is brought to you by code-projects.org ").withStyle("font-size:9px;"),
                                        p("Get more projects like this from : https://code-projects.org/").withStyle("font-size:9px;")
                                )
